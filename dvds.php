...
print "<center><a class='book, buttonl' href='index.php'>Books</a>&nbsp&nbsp<a c                                                                                                                                                                                        lass='book, buttonl' href='cds.php'>CDs</a></center>";
...
echo'<p><center>
<form action="dvds.php?go" method="post">
...
$squery = "AND (v.TITLE LIKE '%".$title."%') ORDER BY TITLE";
}
if ($_POST['field'] == 'A') {
...
$squery = "AND (v.PRODUCT_INFO LIKE '%".$title."%') ORDER BY TITLE";
}
if ($_POST['showall']) {
echo 'it was S';
...
$sql = "SELECT v.ROWKEY, v.TITLE, v.PRODUCER, v.RELEASE_DATE, v.DATE_ENTERED,
v.RUNNING_TIME, v.SUBTITLED, v.CLOSED_CAP, v.IMAGE1_DATA, v.PRODUCT_INFO, c.LIST                                                                                                                                                                                        ITEM
FROM VIDEOWARE AS v LEFT JOIN PUBLISHER_LIST AS c ON  v.PUBLISHER = c.ROWKEY
WHERE (v.STATUS = 1)  $squery";
...
if ($result->num_rows > 0) {
    echo "<center><table>
        <tr class='header'>
        <th align='left'><a href='dvds.php?sort=title'>TITLE</a></th>
        <th class='m01' align='left'><a href='dvds.php?sort=author'>PUBLISHER</a                                                                                                                                                                                        ></th>
